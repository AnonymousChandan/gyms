...
//fetch data trainer
    useEffect(()=>{
        fetch("https://gym-server-side.herokuapp.com/trainer",{
            method:"GET",
            headers:{
                "authorization": token,
            }
    ...
    //fetch data Aerobics
    useEffect(()=>{
        fetch('https://gym-server-side.herokuapp.com/Aerobics', {
  method: 'GET',
  headers: {
  ...
  .catch((error) => {
    ...
    //fetch data cardio
    useEffect(()=>{
        fetch('https://gym-server-side.herokuapp.com/cardio', {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
  },
  ...
  .catch((error) => {
    ...
    useEffect(()=>{
        fetch('https://gym-server-side.herokuapp.com/weigh', {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
  },
